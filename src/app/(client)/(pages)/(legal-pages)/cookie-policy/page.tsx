      ...
      <div className="my-6 md:my-8">
        ...
        <div className="text-sm text-justify">
          ...
          <div>
            <ul className="list-disc list-inside">
              ...
              <li>
                ...
                displaying relevant products, offers, and advertisements based
                on your browsing history and preferences.
              </li>
              <li>
                To deliver targeted advertising to you on our website and on
                other websites that you visit, based on your browsing behavior
                and interests.
              </li>
            </ul>
          </div>
          ...
          <div>
            <ul className="list-disc list-inside">
              ...
              <li>
                ...
                choices and preferences, such as your language, currency, or
                login details. They enhance your experience on our website and
                make it more user-friendly, such as by greeting you by name,
                displaying your recently viewed products, or saving your
                shopping cart.
              </li>
              <li>
                Advertising cookies: These cookies are used to deliver relevant
                and personalized advertisements to you on our website and on
                other websites that you visit. They also help us to measure the
                effectiveness of our advertising campaigns, such as by tracking
                how many times you see or click on an ad, or how much you spend
                on our website after seeing an ad.
              </li>
            </ul>
          </div>
          <br />
          ...
          <p>
            ...
            that if you disable or delete cookies, some features and functions
            of our website may not work properly, and your experience may be
            less personalized and enjoyable.
          </p>
          <p className="break-words">
            For more information on how to manage your cookie preferences,
            please visit the help pages of your browser or visit
            https://www.aboutcookies.org, which provides detailed guidance for
            all modern browsers.
          </p>
          <br />
          ...
          <p>
            ...
            our use of cookies and similar technologies, or to comply with legal
            or regulatory requirements. We will notify you of any significant
            changes by posting a notice on our website or by sending you an
            email. We encourage you to review this policy periodically to stay
