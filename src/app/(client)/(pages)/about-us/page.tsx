...
export default function AboutUs() {
  return (
    <div className="flex flex-col md:gap-5">
      <Container>
        <div className="flex flex-col md:gap-3 py-6 gap-5 ">
          ...
          <div className="flex flex-col gap-10 text-justify md:leading-loose text-sm ">
            {para1}
          </div>

          <div className=" md:gap-10 items-center md:grid md:grid-cols-2  space-y-2 ">
            <div className="">
              <Image
            ...
            <div className="flex flex-row text-justify md:leading-loose text-sm  ">
              {para2}
            </div>
            </div>
          </div>
